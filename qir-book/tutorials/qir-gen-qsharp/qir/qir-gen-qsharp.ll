...
@Teleportion__int2bool = constant [4 x void (%Tuple*, %Tuple*, %Tuple*)*] [void (%Tuple*, %Tuple*, %Tuple*)* @Teleportion__int2bool__body__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null]
@Teleportion__TeleportClassicalMessage = constant [4 x void (%Tuple*, %Tuple*, %Tuple*)*] [void (%Tuple*, %Tuple*, %Tuple*)* @Teleportion__TeleportClassicalMessage__body__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null, void (%Tuple*, %Tuple*, %Tuple*)* null]
@0 = internal constant [3 x i8] c"()\00"

@Teleportion__Greetings__Interop = alias void (), void ()* @Teleportion__Greetings__body

define void @Teleportion__Greetings__body() #0 {
entry:
  ...
  %11 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Teleportion__int2bool, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %msg = call %Array* @Microsoft__Quantum__Arrays___a10467a7e2c24129b4af63e246ec754a_ForEach__body(%Callable* %11, %Array* %0)
  call void @__quantum__rt__array_update_alias_count(%Array* %msg, i32 1)
  %12 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Teleportion__TeleportClassicalMessage, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %transferred = call %Array* @Microsoft__Quantum__Arrays___945f0722763a47fea7a64d64c544670d_ForEach__body(%Callable* %12, %Array* %msg)
...
header__1:                                        ; preds = %exiting__1, %entry
  %index = phi i64 [ 0, %entry ], [ %20, %exiting__1 ]
...
body__1:                                          ; preds = %header__1
  ...
  %19 = call %String* @__quantum__rt__bool_to_string(i1 %18)
  call void @__quantum__rt__message(%String* %19)
...
define %Array* @Microsoft__Quantum__Arrays___a10467a7e2c24129b4af63e246ec754a_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %8 = call %Range @Microsoft__Quantum__Arrays___ca980177e7d5492fa3d84defdd7b4e53_IndexRange__body(%Array* %array)
...
define void @Teleportion__int2bool__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  %0 = bitcast %Tuple* %arg-tuple to { i64 }*
  %1 = getelementptr inbounds { i64 }, { i64 }* %0, i32 0, i32 0
  %2 = load i64, i64* %1, align 4
  %3 = call i1 @Teleportion__int2bool__body(i64 %2)
...
define %Array* @Microsoft__Quantum__Arrays___945f0722763a47fea7a64d64c544670d_ForEach__body(%Callable* %action, %Array* %array) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %action, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %action, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
exit__1:                                          ; preds = %header__1
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %1, i32 1)
  call void @__quantum__rt__array_update_reference_count(%Array* %1, i32 1)
  %8 = call %Range @Microsoft__Quantum__Arrays___8fe86bfba38e4fb1a6dbdca8e250d3d7_IndexRange__body(%Array* %array)
  %9 = extractvalue %Range %8, 0
  %10 = extractvalue %Range %8, 1
  %11 = extractvalue %Range %8, 2
  br label %preheader__1
...
define void @Teleportion__TeleportClassicalMessage__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  %0 = bitcast %Tuple* %arg-tuple to { i1 }*
  %1 = getelementptr inbounds { i1 }, { i1 }* %0, i32 0, i32 0
  %2 = load i1, i1* %1, align 1
  %3 = call i1 @Teleportion__TeleportClassicalMessage__body(i1 %2)
  %4 = bitcast %Tuple* %result-tuple to { i1 }*
  %5 = getelementptr inbounds { i1 }, { i1 }* %4, i32 0, i32 0
  store i1 %3, i1* %5, align 1
  ret void
...
define i1 @Teleportion__TeleportClassicalMessage__body(i1 %message) {
entry:
...
continue__1:                                      ; preds = %then0__1, %entry
  call void @Teleportion__Teleport__body(%Qubit* %msg, %Qubit* %target)
...
define void @Teleportion__Teleport__body(%Qubit* %msg, %Qubit* %target) {
entry:
...
define i1 @Teleportion__int2bool__body(i64 %bit) {
entry:
  %0 = icmp eq i64 %bit, 1
...
define %Range @Microsoft__Quantum__Arrays___8fe86bfba38e4fb1a6dbdca8e250d3d7_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
...
define %Range @Microsoft__Quantum__Arrays___ca980177e7d5492fa3d84defdd7b4e53_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %array)
  %1 = sub i64 %0, 1
...
define void @Teleportion__Greetings() #1 {
entry:
  call void @Teleportion__Greetings__body()
